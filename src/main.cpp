...
uint256 hashGenesisBlock("0x000000008f6fb4983e827e24c26f7e329cb31ccc867297d2ddbe1a05a623cbd9");
...
const string strMessageMagic = "Phalanx Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 75000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 75000);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000008f6fb4983e827e24c26f7e329cb31ccc867297d2ddbe1a05a623cbd9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1425671906;
        block.nBits    = 486604799;
        block.nNonce   = 1430661291;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PhalanxMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PhalanxMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running PhalanxMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PhalanxMiner terminated\n");
        throw;
    }
}
